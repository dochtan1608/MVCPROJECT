...
namespace TourProject.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductID,ProductName,ProductDescription,CategoryID,ProductPrice,ProductDiscount,ProductPhoto,SizeId,ColorId,ProductTitle,IsTrandy,IsArrived")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductID,ProductName,ProductDescription,CategoryID,ProductPrice,ProductDiscount,ProductPhoto,SizeId,ColorId,ProductTitle,IsTrandy,IsArrived")] Product product)
        {
